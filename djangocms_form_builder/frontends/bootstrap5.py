...
if not getattr(django_settings, "DJANGOCMS_FORM_BUILDER_COLOR_STYLE_CHOICES", False):
    ...
    SUBMIT_BUTTON_CHOICES = django_settings.DJANGOCMS_FORM_BUILDER_COLOR_STYLE_CHOICES
